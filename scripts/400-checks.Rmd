...
write_rds(final_v0, here(path(path_te_shared, path_output),"deliver/archived", "final_v0.rds"))
write.csv(final_v0, here(path(path_te_shared, path_output),"deliver/archived", "final_v0.csv"))

write_rds(final_s0, here(path(path_te_shared, path_output),"deliver/archived", "final_s0.rds"))
write.csv(final_s0, here(path(path_te_shared, path_output),"deliver/archived", "final_s0.csv"))
